namespace ComfyUIHelper.Models
{
    public class UpscaleImageSchema
    {
        ...
        public readonly static ComfyUiParameter LoadLora1Strength = new ("Api_LoadLora1", "strength_model", typeof(double));

        public readonly static ComfyUiParameter LoadLora2 = new ("Api_LoadLora2", "lora_name", typeof(string));
        public readonly static ComfyUiParameter LoadLora2Strength = new ("Api_LoadLora2", "strength_model", typeof(double));

        public readonly static ComfyUiParameter LoadLora3 = new ("Api_LoadLora3", "lora_name", typeof(string));
        public readonly static ComfyUiParameter LoadLora3Strength = new ("Api_LoadLora3", "strength_model", typeof(double));
